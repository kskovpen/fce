...
_EXPR_TOOLTIP = (
    ...
    "             (the recoil of the visible system: a full 4-vector,\n"
    "              since the collision energy is known)\n\n"
    "4-vector arithmetic (p4 objects: + and -)\n"
    "  .e/.E/.energy  .m/.M/.mass  .pt/.rho  .eta  .phi  .px .py .pz  .p\n"
    "  (l1.p4 + l2.p4).mass   → invariant mass\n"
    "  (l1.p4 + l2.p4).pt     → system pT\n"
    "  (l1.p4 + l2.p4).e      → system energy\n"
    "  (l1.p4 + met.p4).mass  → mass recoiling against the lepton\n"
